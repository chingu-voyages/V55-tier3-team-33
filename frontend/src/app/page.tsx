    ...
    <div className="flex flex-1 items-center justify-end min-h-full px-4 sm:px-12">
      <main className="ml-auto max-w-xl w-full">
        <div className="bg-white flex flex-col justify-center p-12 gap-8 shadow-xl rounded-lg">
          <h1 className="text-4xl text-center font-bold text-gray-900"><FontAwesomeIcon icon={faPersonRunning} /> My Trainer</h1>
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button variant="outline">Learn More</Button> {/* make it scroll , bring to features, infos etc*/}
          </div>
          <div className="flex justify-center gap-4 text-sm text-gray-600">Already have one account?</div>
        </div>
      </main>
    </div>
  );
